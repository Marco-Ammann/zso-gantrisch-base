...
export class UsersPage {
  ...
  public readonly dummyUsers: UserDoc[] = [
    { uid:'1',  email:'alpha@example.com',  firstName:'(d) Alice', lastName:'Altenburg', roles:['user'],  approved:true,  blocked:false, createdAt:1702406400000, updatedAt:1702406400000 },
    { uid:'2',  email:'bravo@example.com',  firstName:'(d) Bob',   lastName:'Bergmann',  roles:['admin'], approved:true,  blocked:false, createdAt:1703119200000, updatedAt:1705701200000 },
    { uid:'3',  email:'carla@example.com',  firstName:'(d) Carla', lastName:'Carlsen',   roles:['user'],  approved:false, blocked:false, createdAt:1706488800000, updatedAt:1706488800000 },
    { uid:'4',  email:'david@example.com',  firstName:'(d) David', lastName:'Döbeli',    roles:['user'],  approved:true,  blocked:true,  createdAt:1704328800000, updatedAt:1704415200000 },
    { uid:'5',  email:'emma@example.com',   firstName:'(d) Emma',  lastName:'Egli',      roles:['user'],  approved:true,  blocked:false, createdAt:1705279200000, updatedAt:1705279200000 },
    { uid:'6',  email:'felix@example.com',  firstName:'(d) Felix', lastName:'Felder',    roles:['user'],  approved:false, blocked:false, createdAt:1706049600000, updatedAt:1706049600000 },
    { uid:'7',  email:'greta@example.com',  firstName:'(d) Greta', lastName:'Gruber',    roles:['user'],  approved:true,  blocked:false, createdAt:1706568000000, updatedAt:1706568000000 },
    { uid:'8',  email:'hans@example.com',   firstName:'(d) Hans',  lastName:'Heiri',     roles:['user'],  approved:true,  blocked:false, createdAt:1702075200000, updatedAt:1702075200000 },
    { uid:'9',  email:'ida@example.com',    firstName:'(d) Ida',   lastName:'Imhof',     roles:['user'],  approved:true,  blocked:true,  createdAt:1702588800000, updatedAt:1702675200000 },
    { uid:'10', email:'jonas@example.com',  firstName:'(d) Jonas', lastName:'Jäggi',     roles:['user'],  approved:true,  blocked:false, createdAt:1701384000000, updatedAt:1701384000000 }
  ];
  ...
  public readonly users$ = this.refresh$.pipe(
    switchMap(() => this.userService.getAll().pipe(
      ...
      switchMap(real => of([ ...real, ...this.dummyUsers.filter(
  ...
  public readonly stats$ = this.refresh$.pipe(
    switchMap(() => this.userService.getAll().pipe(
      switchMap(real => of([ ...real, ...this.dummyUsers.filter(d=>!real.some(u=>u.uid===d.uid)) ]))
    )),
    map(a => ({
      total  : a.length,
  ...
  private confirm(cb: () => void, msg: string, type:'danger'|'primary'='primary'){
