...
@Component({
  ...
  template: `
    <div #backdrop class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4 opacity-0 pointer-events-none transition-opacity duration-200"
...
export class ConfirmationDialogComponent {
  ...
  @Input() message = 'Sind Sie sicher, dass Sie diese Aktion durchführen möchten?';
